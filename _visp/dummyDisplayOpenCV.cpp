/****************************************************************************
 *
 * $Id: DummyDisplayOpenCV.cpp 5204 2015-01-24 13:18:18Z fspindle $
 *
...
std::vector<std::string> DummyDisplayOpenCV::m_listTitles = std::vector<std::string>();
unsigned int DummyDisplayOpenCV::m_nbWindows = 0;
...
*/
DummyDisplayOpenCV::DummyDisplayOpenCV(vpImage<unsigned char> &I,
                                 int x,
                                 int y,
                                 const char *title)
  :
...
/*!
  ...
  \param title : Window title.
*/
DummyDisplayOpenCV::DummyDisplayOpenCV(vpImage<vpRGBa> &I,
                                 int x,
                                 int y,
                                 const char *title)
  :
...
/*!
  ...
  \code
#include <visp/DummyDisplayOpenCV.h>
#include <visp/vpImage.h>

int main()
{
  DummyDisplayOpenCV d(100, 200, "My display");
  vpImage<unsigned char> I(240, 384);
  d.init(I);
}
  \endcode
*/
DummyDisplayOpenCV::DummyDisplayOpenCV ( int x, int y, const char *title )
  :
    #if (VISP_HAVE_OPENCV_VERSION < 0x020408)
    background(NULL), col(NULL), cvcolor(), font(NULL),
    #else
...
int main()
{
  DummyDisplayOpenCV d;
  vpImage<unsigned char> I(240, 384);
  d.init(I, 100, 200, "My display");
}
  \endcode
*/
DummyDisplayOpenCV::DummyDisplayOpenCV()
  :
    #if (VISP_HAVE_OPENCV_VERSION < 0x020408)
    background(NULL), col(NULL), cvcolor(), font(NULL),
    #else
...
*/
void
DummyDisplayOpenCV::init(vpImage<unsigned char> &I,
                      int x,
                      int y,
                      const char *title)
{
...
*/
void
DummyDisplayOpenCV::init(vpImage<vpRGBa> &I,
                      int x,
                      int y,
                      const char *title)
{
...
*/
void
DummyDisplayOpenCV::init(unsigned int w, unsigned int h,
                      int x, int y,
                      const char *title)
{
  this->width  = w;
...
*/
void
DummyDisplayOpenCV::setFont(const char * /* font */)
{
 ...
 */
void
DummyDisplayOpenCV::setTitle(const char * /* title */)
{
...
*/
void DummyDisplayOpenCV::setWindowPosition(int winx, int winy)
{
...
*/
void DummyDisplayOpenCV::displayImage(const vpImage<unsigned char> &I)
{
  if (displayHasBeenInitialized)
  {
    vpImage<vpRGBa> Ic;
...
/*!
  ...
  \sa init(), closeDisplay()
*/
void DummyDisplayOpenCV::displayImageROI ( const vpImage<unsigned char> &I,const vpImagePoint &iP,
...
/*!
  ...
  \sa init(), closeDisplay()
*/
void DummyDisplayOpenCV::displayImage(const vpImage<vpRGBa> &I)
{
...
/*!
  ...
  \sa init(), closeDisplay()
*/
void DummyDisplayOpenCV::displayImageROI ( const vpImage<vpRGBa> &I,const vpImagePoint &iP,
                                        const unsigned int w, const unsigned int h )
{
  if (displayHasBeenInitialized)
  {
...
/*!
  ...
  \sa init(), closeDisplay()
*/
void DummyDisplayOpenCV::displayImage(const unsigned char * /* I */)
{
  vpTRACE(" not implemented ") ;
}
...
*/
void DummyDisplayOpenCV::closeDisplay()
{
  if (col != NULL)
  {
    delete [] col ; col = NULL ;
...
*/
void DummyDisplayOpenCV::flushDisplay()
{
  if (displayHasBeenInitialized)
  {
#if (VISP_HAVE_OPENCV_VERSION < 0x020408)
...
*/
void DummyDisplayOpenCV::flushDisplayROI(const vpImagePoint &/*iP*/, const unsigned int /*width*/, const unsigned int /*height*/)
{
  if (displayHasBeenInitialized)
  {
#if (VISP_HAVE_OPENCV_VERSION < 0x020408)
...
*/
void DummyDisplayOpenCV::clearDisplay(const vpColor & /* color */)
{
  static bool warn_displayed = false;
  if (! warn_displayed) {
    vpTRACE("Not implemented");
...
*/
void DummyDisplayOpenCV::displayArrow ( const vpImagePoint &ip1,
...
/*!
  ...
  \sa setFont()
*/
void DummyDisplayOpenCV::displayCharString( const vpImagePoint &ip,
                                     const char *text,
				     const vpColor &color )
{
  if (displayHasBeenInitialized)
...
*/
void DummyDisplayOpenCV::displayCircle(const vpImagePoint &center,
				    unsigned int radius,
				    const vpColor &color,
				    bool  fill ,
				    unsigned int thickness)
...
*/
void
DummyDisplayOpenCV::displayCross(const vpImagePoint &ip,
                              unsigned int size,
                              const vpColor &color,
			      unsigned int thickness)
{
...
*/
void
DummyDisplayOpenCV::displayDotLine(const vpImagePoint &ip1,
                                const vpImagePoint &ip2,
                                const vpColor &color,
                                unsigned int thickness)
{
...
*/
void
DummyDisplayOpenCV::displayLine(const vpImagePoint &ip1,
			     const vpImagePoint &ip2,
			     const vpColor &color,
			     unsigned int thickness)
{
...
*/
void DummyDisplayOpenCV::displayPoint(const vpImagePoint &ip,
                                   const vpColor &color)
{
  if (displayHasBeenInitialized)
  {
...
*/
void
DummyDisplayOpenCV::displayRectangle(const vpImagePoint &topLeft,
                                  unsigned int w, unsigned int h,
...
*/
void
DummyDisplayOpenCV::displayRectangle(const vpRect &rectangle,
                                  const vpColor &color, bool fill,
                                  unsigned int thickness)
{
  if (displayHasBeenInitialized)
...
*/
bool
DummyDisplayOpenCV::getClick(bool blocking)
{
  bool ret = false;
  if (displayHasBeenInitialized) {
    flushDisplay() ;
...
*/
bool
DummyDisplayOpenCV::getClick(vpImagePoint &ip, bool blocking)
{
  bool ret = false;
...
*/
bool
DummyDisplayOpenCV::getClick(vpImagePoint &ip,
...
*/
bool
DummyDisplayOpenCV::getClickUp(vpImagePoint &ip,
                            vpMouseButton::vpMouseButtonType& button,
                            bool blocking)
{
  bool ret = false;
...
*/
void DummyDisplayOpenCV::getImage(vpImage<vpRGBa> &I)
{
  vpImageConvert::convert(background,I);
  // should certainly be optimized.
}

void DummyDisplayOpenCV::on_mouse( int event, int x, int y, int /*flags*/, void* display )
{
  DummyDisplayOpenCV* disp = (DummyDisplayOpenCV*)display;
  switch ( event )
  {
#if (VISP_HAVE_OPENCV_VERSION < 0x020408)
...
*/
bool
DummyDisplayOpenCV::getKeyboardEvent(bool blocking)
{
  int key_pressed;
  int delay;
  if (displayHasBeenInitialized) {
...
*/
bool
DummyDisplayOpenCV::getKeyboardEvent(char *string, bool blocking)
{
  int key_pressed;
  int delay;
  if (displayHasBeenInitialized) {
...
*/
bool
DummyDisplayOpenCV::getPointerMotionEvent (vpImagePoint &ip )
{
  bool ret = false;
...
*/
bool
DummyDisplayOpenCV::getPointerPosition ( vpImagePoint &ip)
{
  if (displayHasBeenInitialized) {
