/****************************************************************************
 *
 * $Id: DummyDisplayOpenCV.h 5023 2014-12-03 16:07:48Z fspindle $
 *
...
#ifndef DummyDisplayOpenCV_h
#define DummyDisplayOpenCV_h
...
/*!
  ...
  \class DummyDisplayOpenCV

  \ingroup ImageGUI

  \brief The DummyDisplayOpenCV allows to display image using the opencv library.
...
class VISP_EXPORT DummyDisplayOpenCV: public vpDisplay
{
private:
...
public:
  DummyDisplayOpenCV() ;
  DummyDisplayOpenCV(int winx, int winy, const char *title=NULL) ;
  DummyDisplayOpenCV(vpImage<unsigned char> &I, int winx=-1, int winy=-1,
	       const char *title=NULL) ;
  DummyDisplayOpenCV(vpImage<vpRGBa> &I, int winx=-1, int winy=-1,
	       const char *title=NULL) ;

  virtual ~DummyDisplayOpenCV() ;
